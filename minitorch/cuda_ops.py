...
def device_jit(fn: Fn, **kwargs) -> Fn:  # noqa
    """JIT compiles the passed fuction based with device"""
    return _jit(device=True, **kwargs)(fn)  # type: ignore


def jit(fn: Fn, **kwargs) -> FakeCUDAKernel:  # noqa
...
class CudaOps(TensorOps):
    ...
    def reduce(
        ...
        """CUDA-based reduction of a tensor using the passed function and starting parameter"""
        cufn: Callable[[float, float], float] = device_jit(fn)
    ...
    def matrix_multiply(a: Tensor, b: Tensor) -> Tensor:
        """Matrix multiplication of the two passed tensors"""
